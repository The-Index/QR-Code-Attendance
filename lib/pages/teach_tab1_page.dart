...
import 'package:miniproject/pages/teach_home_page.dart';
import 'package:miniproject/pages/teach_tab2_page.dart';
...
class _TeacherBasicPageState extends State<TeacherBasicPage> {
  ...
  Future<void> showCustomDialogWithImage(BuildContext context) async {
    if (validateAndSave()) {
      ...
      final decryptedQR = encrypter.decrypt(encryptedQR, iv: iv);
